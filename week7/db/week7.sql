...
(2, 'joke 2', '2023-10-07', 2, 2),
(3, 'joke 3', '2023-10-10', 2, 2);
...
ALTER TABLE `joke`
  ...
  ADD CONSTRAINT `joke_ibfk_2` FOREIGN KEY (`categoryid`) REFERENCES `category` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
